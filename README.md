...
This is Manasa2807 build training repository.
...
<<<<<<< HEAD
- [Done] **STEP1** Git ([JA](document/01-git.ja.md)/[EN](document/01-git.en.md))
- [Done] **STEP2** Setup environment ([JA](document/02-local-env.ja.md)
=======
<<<<<<< Updated upstream
...
- [Done] **STEP2** Setup environment ([JA](document/02-local-env.ja.md)
>>>>>>> Stashed changes
>>>>>>> a2f1f93 (Updated README, items.json, and main.py)
