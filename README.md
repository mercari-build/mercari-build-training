...
- [ ] **STEP6** Docker ([JA](document/06-docker.ja.md)/[EN](document/06-docker.en.md))
- [ ] **STEP7** Continuous Integration(CI) ([JA](document/07-ci.ja.md)
  /[EN](document/07-ci.en.md))
- [ ] **STEP8** (Stretch) Frontend ([JA](document/08-frontend.ja.md)
  /[EN](document/08-frontend.en.md))
- [ ] **STEP9** (Stretch)  Run multi service ([JA](document/09-docker-compose.ja.md)
  /[EN](document/09-docker-compose.en.md))
