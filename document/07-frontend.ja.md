...
:warning: 注意点として、多くの React の教材等で紹介されている`create-react-app`は、2025 年 2 月 14 日に非推奨となることが[正式にアナウンス](https://react.dev/blog/2025/02/14/sunsetting-create-react-app)されました。
