...
In this screen, item images are all rendered as Build@Mercari logo. Specify the item image as `http://localhost:9001/image/<item_id>.jpg` and see if they can be displayed on the web app.
